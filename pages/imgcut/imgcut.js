Page({
	...
	eok: function() {
		var self = this;
		var context = wx.createCanvasContext('imgcanvas')
		context.clearRect(0, 0, this.data.wd, this.data.ht);
		context.save();
		context.rotate(this.data.angles * Math.PI / 180);
		context.drawImage(this.data.oldimg, this.data.posX, this.data.posY, this.data.oldwd * this.data.zoomStart, this.data.oldht * this.data.zoomStart)
